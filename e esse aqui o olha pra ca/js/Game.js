...
//=------->
  ...
  showLife() {
   ...
   fill("white")
   rect(width/2-100,height-player.positionY-275,92,20)
   fill("red")
  ...
  showFuelBar() {
    ...
    fill("white")
    rect(width/2-100,height-player.positionY-300,92,20)
    fill("brown")
  ...
  showRank() {
    swal({
      title: `Incrível!${"\n"}${player.rank}º lugar`,
      text: "Você provou ser o mais rapido!",
      imageUrl:
